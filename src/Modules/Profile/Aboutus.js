    ...
    return (
        <div className='AboutUsPage'>
            <div className="TopHeadP row">
                ...
                <span className='commonHeading' style={{ marginTop: '10px', marginBottom: '10px' }}>About Us</span>
            </div>
            <img style={{ width: '50%' }} src="/Images/logo.png" alt="" />
            <div style={{ textAlign: 'initial', padding: '0 10px' }} className="lightText">
                Dusminute is India's first Hyperlocal managed living platform which brings all the amentities and requirements of residents at their doorstep. With our stores located within the community complexes offering retail (grocery, dairy, fruits, vegitables & household items) and mobile app for delivery and all other home services (via subscription and group buying), we are redefining the modern urban living by providing hotel like convenience at home
            </div>
            <div onClick={() => { window.location.href = 'https://www.dusminute.com/privacy-policy' }} className="Aboutlink">
                Privacy Policy
            </div>
            <div onClick={() => { window.location.href = 'https://www.dusminute.com/privacy-policy' }} className="Aboutlink">
