    ...
    return (
        <div className='Querypage'>
            <div style={{ backgroundColor: 'white', marginBottom: '10px' }} className="TopHeadP row">
                ...
                <span className='commonHeading' style={{ fontSize: '18px', marginTop: '10px', marginBottom: '10px' }}>Help</span>
            </div>
            <div style={{ width: 'calc(100% - 40px)', borderRadius: '10px', backgroundColor: 'white', margin: '10px', padding: '10px' }} className="">
                ...
                <div style={{ justifyContent: 'center', marginBottom: '10px' }} className="CartPopUp highlighter12"><i class="fa-solid fa-phone"></i>&ensp; Click to call Customer Support</div>
                    ...
                    <div style={{ lineHeight: '30px', textAlign: 'initial', padding: '10px', color: '#323B4C' }} className="">
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '50% 50%' }}>
                            <div style={{ display: 'flex', alignItems: 'center' }} className="">
                                <input type="checkbox" id="OR" name="OR" />&ensp;
                                <label for="OR"> Order Related</label><br></br>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center' }} className="">
                                <input type="checkbox" id="PR" name="PR" />&ensp;
                                <label for="PR"> Payment Related</label><br></br>
                            </div>
                        </div>
                        <div style={{ display: 'grid', gridTemplateColumns: '50% 50%' }}>
                            <div style={{ display: 'flex', alignItems: 'center' }} className="">
                                <input type="checkbox" id="IR" name="IR" />&ensp;
                                <label for="IR"> Item Related</label><br></br>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center' }} className="">
                                <input type="checkbox" id="Oth" name="Oth" />&ensp;
